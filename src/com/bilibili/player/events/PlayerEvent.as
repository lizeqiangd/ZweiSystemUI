package com.bilibili.player.events {
	...
	public class PlayerEvent extends Event {
		 ...
		 */
		public static var LOCKED:String = "Locked";
		 ...
		 */
		public static var UNLOCKED:String = "Unlocked";
		...
		public function PlayerEvent(type:String, msg:String=undefined) {
			...
			try {
				this.id = BPSetting.PlayerVersion ? BPSetting.PlayerVersion : ExternalInterface.objectID;
			} catch(e:Error) {}
			this.client = "FLASH " + Capabilities.version;
			this.version = BPSetting.PlayerVersion
			this.message = msg;
		}
