package com.bilibili.player.events
{
	 ...
	 * buffer:Number=-1
	 * mute:Boolean = false;
	 * 20141031 重新修改其概念.取JW化.  本类修改自JWPlayer的MediaEvent
	 * 20141104 增加直接获得buffer时间的属性.
	...
	public class MediaEvent extends PlayerEvent
	{
		 ...
		 */
		public static var MEDIA_BUFFER:String = "MediaBuffer";
		 ...
		 */
		public static var MEDIA_BUFFER_FULL:String = "MediaBufferFull";
		 ...
		 */
		public static var MEDIA_LOADED:String = "MediaLoaded";
		 ...
		 */
		public static var MEDIA_SEEK:String = "MediaSeek";
		 ...
		 */
		public static var MEDIA_TIME:String = "MediaTime";
		 ...
		 */
		public static var MEDIA_VOLUME:String = "MediaVolume";
		 ...
		 */
		//public static var MEDIA_MUTE:String = "MediaMute";
		
		/**
		 * 用于视频大小切换的时候交给外部处理
		 */ 
		public static const MEDIA_RESIZE:String ="MediaResize"
		...
		public override function toString():String
		{
			...
			if (bufferPercent != defaults.bufferPercent)
